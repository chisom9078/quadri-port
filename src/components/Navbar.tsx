    ...
    <div className="w-full h-24 sticky top-0 z-50 backdrop-blur-2xl transition-colors bg-bodyColor/70 mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600 px-4">
      ...
      <div>
        ...
        <span
          ...
          className="text-xl mdl:hidden bg-black w-10 h-10 inline-flex items-center justify-center rounded-full text-sky-500 cursor-pointer"
        >
          <FiMenu />
        </span>
        {showMenu && (
            ...
            <div className="flex flex-col gap-8 py-2 relative">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    href="https://web.facebook.com/karim.twez?_rdc=1&_rdr"
                    target="_blank"
                  >
                    <span className="bannerIcon">
                      <FaFacebookF />
              ...
              <span
                onClick={() => setShowMenu(false)}
                className="absolute top-4 right-4 text-gray-400 hover:text-sky-500 duration-300 text-2xl cursor-pointer"
              >
                <MdClose />
              </span>
            </div>
